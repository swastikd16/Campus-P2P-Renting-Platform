...
import { Menu, X, PlusCircle, Search, User, Home } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <NavLink to="/" className="flex items-center space-x-2 font-bold text-xl">
              ...
              <span className="hidden sm:inline">Campus P2P by CipherOps</span>
              <span className="sm:hidden">CipherOps</span>
            </NavLink>
          </div>
          ...
          <div className="-mr-2 flex md:hidden">
            <button
              ...
              className="bg-indigo-600 inline-flex items-center justify-center p-2 rounded-md text-indigo-100 hover:text-white hover:bg-indigo-500 focus:outline-none"
            >
